...
- twenty Exercism exemplar solutions run against their unchanged `unittest` suites;
...
The manifest pins repository revisions and hashes every executed fixture. The adjacent license files
come from those revisions. The zlib files are the vendored zlib 1.2.8 copy in the pinned Oils tree;
its `README` contains the upstream license notice.
