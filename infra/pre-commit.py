    ...
    return (
        ...
        Check(
            ...
            (
                ...
                "tests/python/test_builtins.py",
                "tests/python/test_language.py",
                "tests/python/test_object_model.py",
                "tests/python_package/test_api.py",
                "tests/python_package/test_cli.py",
                "tests/tooling/test_command_census.py",
                "tests/tooling/test_tasktrove_runtime_probe.py",
                "infra/marin-style.py",
            ),
        ),
